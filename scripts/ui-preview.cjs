...
app.on('browser-window-created', (_, win) => {
  ...
  win.webContents.once('did-finish-load', async () => {
    try {
      ...
      await delay(80)
      assert.equal(await win.webContents.executeJavaScript(`document.querySelector('.diagform textarea').disabled && [...document.querySelectorAll('.workspaceContent button')].find(x=>x.textContent.includes('Zapisz diagnostykę')).disabled`),true)
